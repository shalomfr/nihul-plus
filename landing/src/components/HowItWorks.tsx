          ...
          {STEPS.map((step, i) => (
            <ScrollReveal key={i} delay={i * 0.15}>
              <div className="text-center relative">
                {/* Step number */}
                <div className="relative z-10 w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#2563eb] to-[#1e40af] mx-auto mb-4 sm:mb-6 flex items-center justify-center shadow-lg shadow-blue-500/20">
                  <span className="text-white font-bold text-base sm:text-lg">{step.number}</span>
                </div>

                <h3 className="text-lg sm:text-xl font-bold text-[#1e293b] mb-2 sm:mb-3">
                  {step.title}
                </h3>
