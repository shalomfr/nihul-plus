      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <ScrollReveal>
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 text-center py-12 sm:py-16 md:py-20 px-5 sm:px-8">
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-white mb-4">
                מוכנים לנהל את העמותה כמו שצריך?
              </h2>
              <p className="text-blue-100 text-base sm:text-lg mb-8 sm:mb-10 max-w-lg mx-auto">
                הצטרפו למאות עמותות שכבר נהנות מליווי מקצועי צמוד
              </p>
              <a
                href={APP_URL}
                className="inline-flex items-center gap-2 bg-white text-[#2563eb] font-bold px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl text-base sm:text-lg hover:bg-blue-50 transition-colors shadow-2xl shadow-black/20"
              >
                התחילו עכשיו — בחינם
                <ArrowLeft size={20} />
              </a>
              <p className="text-blue-200/70 text-xs sm:text-sm mt-4">
